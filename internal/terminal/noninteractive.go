...
func (ui *nonInteractiveUI) Input(_ *Input) (string, error) {
...
func (ui *nonInteractiveUI) Successf(format string, a ...any) {
	ui.Output(colorSuccess.Sprintf(format, a...))
}

func (ui *nonInteractiveUI) Warnf(format string, a ...any) {
	ui.Output(colorWarning.Sprintf(format, a...))
}

func (ui *nonInteractiveUI) Infof(format string, a ...any) {
	ui.Output(colorInfo.Sprintf(format, a...))
}

func (ui *nonInteractiveUI) Errorf(format string, a ...any) {
	ui.Output(formatError(nil, format, a...))
}

func (ui *nonInteractiveUI) ErrorWithSummary(err error, summary string, a ...any) {
	ui.Output(formatError(err, summary, a...))
}
...
func (f *nonInteractiveStep) Status(_ string) {}
